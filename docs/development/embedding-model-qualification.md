...
- 目标 CPU 主机在 4 GiB、CPU-only、`network=none` 下无 OOM，三轮热态查询 P95 为 149.476 / 149.305 / 150.096 ms；
- 36 组批量索引基线全部成功；`mock-eval-v1` 权限泄漏率 0%、引用错误率 0%、降级通过率 100%、Recall@5 96%。
